...
public:
	...
	inline void setPixel(unsigned int x, unsigned int y, const float& c) { pixels[y * width + x] = c; }
...
public:
	...
	//circles
	void drawCircle(int x, int y, int r, Color c, bool filled);
	//triangles
	void Image::drawTriangle(int x0, int y0, int z0, int x1, int y1, int z1, int x2, int y2, int z2, Color c, bool filled);
	void drawUnfilledTriangle(int x0, int y0, int x1, int y1, int x2, int y2, Color c);
	...
	//squares
	void drawSquare(int x, int y, int size, Color c, bool filled);
